const voices = [
  {name:"0尹佳绮 ", role:"湖南云山学校  · 00后校长 ", preview:"毕竟是我毕业之后第一个学校、第一批学生 ", quote:["毕竟是我毕业之后第一个学校、第一批学生、第一个环境。 ","希望我们未来都会越来越好，我会永远记得我是从这里出发的。 "]},
  {name:"0张娜 ", role:"陕西策村小学  · 16年教龄教师 ", preview:"撤不撤我也没有办法 ", quote:["撤不撤我也没有办法。 ","所有学习都要靠我们去抓，没有别的环境可以依靠。 "]},
  {name:"0曾良平 ", role:"湖南云山学校  · 41年教龄老教师 ", preview:"我最放心不下的，是那些没钱没势的穷孩子 ", quote:["我最放心不下的，是那些没钱没势的穷孩子。 ","形式主义表格太多，把教书的时间都占了。 "]},
  {name:"0黄老师 ", role:"广西恭城瑶族自治县  · 双科教师 ", preview:"山里面不会听我们外地人的 ", quote:["山里面不会听我们外地人的。 ","撤校的事情我们在学校都是避而不谈的。 "]},
  {name:"0王志超 ", role:"衡水建国镇中心校主任 ", preview:"撤不撤都会有困难 ", quote:["撤不撤都会有困难。 ","学生比较少的成绩却很好，这是不是和小班有关系。 "]},
  {name:"0赵小旺 ", role:"兴平市教育局基教科科长 ", preview:"教育永远围绕以学生为中心 ", quote:["教育永远围绕以学生为中心，服务辖区人民群众。 ","未来村小撤并的趋势必然是教育资源全面整合升级。 "]},
  {name:"0曾皓轩 ", role:"湖南云山学校  · 学生 ", preview:"因为我讨厌妈妈 ", quote:["因为我讨厌妈妈。 ","我不想爷爷给我送饭了，不然他会快一点变老的。 "]},
  {name:"0华芝涵 ", role:"扬州市渌洋湖中心小学  · 学生 ", preview:"老师有时候会拿教棍打手 ", quote:["老师有时候会拿教棍打手，或者打几下头，在学业方面比较负责，但是育人方面不太行。 ","在农村读的小学让我看不到希望。 "]}
];
...
voices.forEach((v,i)=>{
  ...
  card.innerHTML = `
    ...
    <div class="v-toggle"><span class="icon">+</span><span class="txt">0展开完整语录 </span></div>
  `;
  card.addEventListener('click',(e)=>
    e.stopPropagation();
    card.classList.toggle('expanded');
    const txt = card.querySelector('.v-toggle .txt');
    txt.textContent = card.classList.contains('expanded') ? '0收起 ' : '展开完整语录 ';
  );
...
function showTip(x,y,d){
  ...
  tooltip.innerHTML = `${d}.year0年： ${d}.value 万所 `;
